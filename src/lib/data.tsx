...
export const portfolioProjects = [
  ...
  },
  {
    ...
    results: [
      {
        title:
          "Built with React Native, Expo, Appwrite, and NativeWind for a modern real estate experience.",
      },
      {
        title:
          "Implemented Google authentication, property browsing, and user profile management.",
      },
      {
        title:
          "Designed clean UI with Tailwind-based styling and reusable components.",
      },
    ],
